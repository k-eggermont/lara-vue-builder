        ...
        <div class="relative">
            ...
            <div class="relative border-2 rounded border-grey-lighter p-4 text-blue text-lg   font-semibold" v-else-if="loading">
                ...
                <div class="opacity-25">
                    ...
                    <p class="text-center text-grey-dark text-xs mt-1">MAX {{ field.maxFiles }} FILE<template v-if="field.maxFiles>1">S</template><template v-if="field.maxSizePerFiles">, AND {{field.maxSizePerFiles}}KB PER FILE.</template></p>
                </div>
            </div>
            ...
            <label class="border-2 text-center rounded border-grey-lighter p-4 text-blue text-lg hover:border-blue cursor-pointer font-semibold" v-else>
                ...
                <p class="text-center text-xs mt-1">MAX {{ field.maxFiles }} FILE<template v-if="field.maxFiles>1">S</template><template v-if="field.maxSizePerFiles">, AND {{field.maxSizePerFiles}}KB PER FILE.</template></p>
